							...
							<div class="card-body">
								<div class="m-sm-4">
									<div class="text-center mb-3">
										<img src="{{url('frontend/img/avatars/avatar.jpg')}}" alt="Avatar" class="img-fluid rounded-circle" width="132" height="132" />
									</div>
									...
									<div class="text-center mt-3">
										<a href="{{ url('login/google') }}" class="btn btn-lg btn-danger">Sign in with Google</a>
									</div>
								</div>
							</div>
						</div>
