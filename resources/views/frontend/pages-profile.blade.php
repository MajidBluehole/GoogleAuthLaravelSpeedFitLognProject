							...
							<div class="card">
								...
								<div class="card-body h-100">
									...
									<div class="d-flex align-items-start">
										<img src="{{url('frontend/img/avatars/avatar-5.jpg')}}" width="36" height="36" class="rounded-circle me-2" alt="Vanessa Tucker">
									...
									<hr />
									<div class="d-flex align-items-start">
										<img src="{{url('frontend/img/avatars/avatar.jpg')}}" width="36" height="36" class="rounded-circle me-2" alt="Charles Hall">
										<div class="flex-grow-1">
									...
									<hr />
									<div class="d-flex align-items-start">
										<img src="{{url('frontend/img/avatars/avatar-4.jpg')}}" width="36" height="36" class="rounded-circle me-2" alt="Christina Mason">
										<div class="flex-grow-1">
									...
									<hr />
									<div class="d-flex align-items-start">
										<img src="{{url('frontend/img/avatars/avatar-2.jpg')}}" width="36" height="36" class="rounded-circle me-2" alt="William Harris">
										<div class="flex-grow-1">
											...
											<div class="row g-0 mt-1">
												<div class="col-6 col-md-4 col-lg-4 col-xl-3">
													<img src="{{url('frontend/img/photos/unsplash-1.jpg')}}" class="img-fluid pe-2" alt="Unsplash">
												</div>
												<div class="col-6 col-md-4 col-lg-4 col-xl-3">
													<img src="{{url('frontend/img/photos/unsplash-2.jpg')}}" class="img-fluid pe-2" alt="Unsplash">
												</div>
											</div>
