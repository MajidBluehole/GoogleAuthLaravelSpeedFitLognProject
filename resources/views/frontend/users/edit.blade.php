                                ...
                                <div class="m-sm-4">
                                    <form action="{{ route('users.update', $user->id) }}" method="post"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="tel" id="mobile"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control form-control-lg" id="country" name="country_id"
                                                required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control form-control-lg" id="state" name="state_id"
                                                required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control form-control-lg" id="city" name="city_id"
                                                required>
